<template>
  <div id="app" class="font-sans fixed text-center">
     <div class="flex inset-0">
    <div class="w-full lg:w-full justify-start">
      ...
      <div class="modal-content">
        <div class="w-auto xl:max-w-xl p-6 space-y-8 md:p-8 rounded-lg shadow-xl " style="background-color: rgba(17, 24, 39, 0.5);">
                <h2 class="text-2xl font-bold text-white opacity-100 dark:text-white opac">
                   #BecomingtheTackies!
                </h2>        <h2 class="text-xl md:mb-6 text-white" >Sorry you can't join us on this journey</h2>
      ...
      <div class="modal-content">
        <div class="w-auto xl:max-w-xl p-6 space-y-8 md:p-8 rounded-lg shadow-xl " style="background-color: rgba(17, 24, 39, 0.5);">
          <img class="mb-2 md:mb-4" src="../assets/logo.png" alt="" />
              ...
              <Countdown />        <p class="mb-4 text-xl font-extrabold">Kindly RSVP</p>
              <div>
          <router-link to="/code">
          <button class="bg-green-700 p-2 mx-2 rounded-lg font-bold" >
...
<router-link to="/decline">
          <button class="bg-red-700 p-2 mx-2 my-2 font-bold rounded-lg" >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mx-2 inline">
...
Decline with Regret
        ...
        <p class="m-2" >Already Registered? <span class="text-purple-900 font-bold"> Login </span> </p>
        </router-link>
      </div>
            </div>
</div>
...
export default {
  ...
  setInterval(() => {
    ...
    if (video) {
      ...
      //   showLogo1.value = false;
      // }
      const threeFourthPoint = (1 / 4) * video.duration;
...
//         this.showModal = false;
//         // Hide the other modal if needed
//         this.showModal1 = true;
//     }
// },
// onVideoPlay() {
//     // Set isVideoPlaying to true
...
//   // },
//   onVideoEnd() {
//     // Check if showModal hasn't been set before
//     if (!this.showModal1) {
//         // Set showModal to true
//         this.showModal1 = true;
...
noEvent() {
    // Check if the video is not playing
    if (!this.isVideoPlaying) {
        // Set showModal to true only if showModal1 is not active
        if (!this.showModal1) {
            this.showModal = true;
        }
        // Hide the other modal if needed
